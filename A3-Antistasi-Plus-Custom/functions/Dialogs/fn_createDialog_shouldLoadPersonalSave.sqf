...
private _saveString = ["Antistasi has a custom save system similar to other CTIs.<br/><br/>",
    format ["To Save: Your commander needs to go to the <t color='#f0d498'>Map Board</t>, scroll-select <t color='#f0d498'>""Game Options""</t> and click on the <t color='%1'>""Persistent Save""</t> button.<br/><br/>", _color]] joinString "";
