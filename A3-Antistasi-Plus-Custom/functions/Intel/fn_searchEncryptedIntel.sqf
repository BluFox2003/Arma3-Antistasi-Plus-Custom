...
private _fileName = "fn_searchEncryptedIntel";

if (isNull _intel || _id isEqualTo -1) exitWith {
    [2, format ["Invalid arguments | Intel obj: %1 | Action ID: %2", _intel, _id], _fileName] call A3A_fnc_log;
};
